<div>
    ...
    <div class="flex items-center min-h-full bg-gray-50">
        <div class="flex-1 h-[90vh] mt-4 overflow-hidden max-w-4xl mx-auto bg-white rounded-lg shadow-xl">
                    ...
                    <form wire:submit.prevent="login" class="w-full">
                        ...
                        <p class="mt-2">
                            <a class="text-sm text-gray-900">
                                Don't have an account? <span><a href="/" class="text-sm text-blue-500 hover:underline">Sign up</a></span>
                            </a>
                        </p>
                        <hr class="my-4" />
