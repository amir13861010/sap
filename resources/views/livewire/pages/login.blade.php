            ...
            <div class="flex flex-col md:flex-row">
                        ...
                        <div>
                            <label class="block mt-4 text-sm relative">
                                ...
                                <input wire:model="password"
                                       class="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600"
                                       placeholder="" type="password" id="password" oninput="updatePasswordStrength()"/>
                                @error('password')
                                @php
                                    flash()->addError($message);
                                @endphp
                                @enderror
                                <button type="button"
                                        class="absolute top-1/2 right-3 transform -translate-y-1/2 text-gray-400 focus:outline-none"
                        ...
                        <p class="mt-4">
                            <a class="text-sm text-gray-900">
                                Don't have an account? <span><a href="/register"
                                                                class="text-sm text-blue-500 hover:underline">Sign up</a></span>
                            </a>
                        </p>
                        <hr class="my-8"/>
                        <div class="flex items-center justify-center gap-4">
                            <button
                                class="flex items-center h-12 justify-center w-full px-4 py-2 text-sm text-gray-700 border border-gray-300 rounded-lg hover:border-gray-500 focus:border-gray-500">
                                Sign in with
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     class="w-4 h-4 mr-4 ml-2" viewBox="0 0 48 48">
                                    <defs>
                                        <path id="a"
                            ...
                            <button
                                class="flex h-12 items-center justify-center w-full px-4 py-2 text-sm text-gray-700 border border-gray-300 rounded-lg hover:border-gray-500 focus:border-gray-500">
                                Sign in with
                ...
                <div class="flex-1 text-center hidden lg:flex">
                    <div class="h-30 md:h-auto md:w-2/2 relative">
                        ...
                        <div
                            class="absolute bottom-0 left-0 mt-7 w-full px-6 pb-6 bg-gray-900 bg-opacity-75 text-white">
                            <span class="text-xl font-bold">This is your </span><span class="text-xl font-bold"
                                                                                      id="dynamic-text"></span>
                        </div>
                    </div>
                </div>
            </div>
